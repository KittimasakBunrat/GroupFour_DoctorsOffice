...
Doctor::Doctor(string first_name, string last_name, int social_number, int phone_number, int employee_number) : Person(first_name, last_name, social_number, phone_number)
{
